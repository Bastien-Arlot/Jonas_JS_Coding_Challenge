...
// Print each player name with the goal number
for(const [goal,player] of game.scored.entries()){
    console.log(`Goal ${goal+1} was score by ${player}`);
};
...
const averageOdd = sum / values.length;
...
// Bonus Create an Object with player's name who score
